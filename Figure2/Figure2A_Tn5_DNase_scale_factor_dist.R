...
load('Figure2A_Tn5_5mer_scalefactors.Rdata')
...
pdf("Figure2A_ATAC_Allscalingvalues.pdf", width=9, height=7)
ATAC.plot.new()
dev.off()
...
load('Figure2A_DNase_5mer_scalefactors.Rdata')
...
pdf("Figure2A_DNase_Allscalingvalues.pdf", width=9, height=7)
DNase.plot.new()
dev.off()

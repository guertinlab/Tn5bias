...
seqOutBias hg38.fa C1_gDNA_rep1.bam --custom-shift=4,-4 --strand-specific --kmer-mask=NNCN \
                                         --bed=C1_gDNA_rep1_NNNXXXC.bed \
                                         --bw=C1_gDNA_rep1_NNNXXXC.bigWig --read-size=76

seqOutBias hg38.fa C1_gDNA_rep1.bam --custom-shift=4,-4 --strand-specific --kmer-mask=CXXXNNN \
                                          --bed=C1_gDNA_rep1_NCNN.bed \
                                          --bw=C1_gDNA_rep1_NCNN.bigWig --read-size=76

seqOutBias hg38.fa C1_gDNA_rep1.bam --custom-shift=4,-4 --strand-specific --kmer-mask=CXXXXXXXXNNN \

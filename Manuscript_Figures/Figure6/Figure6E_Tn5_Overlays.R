...
################################################################################
load('Figure6E_overlay_list.Rdata')
#Plot overlays:
################################################################################
################################################################################
#Plot seqOutBias overlay
plot.composites(Figure6E_overlay_list[[1]], legend = FALSE, 
                pdf_name = 'Figure6E_Tn5_seqOutBias_overlay',
...
plot.composites(Figure6E_overlay_list[[2]], legend = FALSE, 
...
plot.composites(Figure6E_overlay_list[[3]], legend = FALSE, 

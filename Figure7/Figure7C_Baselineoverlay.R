...
Tn5_unscaled_composites_overlay = Tn5_unscaled_composites_overlay[which(Tn5_unscaled_composites_overlay$group == 'E2F1_rm_plus' | Tn5_unscaled_composites_overlay$group == 'MEF2A_rm_plus'),]
...
plot.composites(Tn5_unscaled_composites_overlay, legend = FALSE, 
                pdf_name = 'Figure7C_Tn5_unscaled_E2F1_MEF2A_overlay',
...
E2F1_baseline = mean(Tn5_unscaled_composites_overlay[which(Tn5_unscaled_composites_overlay$group == 'E2F1_rm_plus'  & Tn5_unscaled_composites_overlay$x > 15.5 |
                                                             Tn5_unscaled_composites_overlay$group == 'E2F1_rm_plus' & Tn5_unscaled_composites_overlay$x < -15.5),2])  



MEF2A_baseline = mean(Tn5_unscaled_composites_overlay[which(Tn5_unscaled_composites_overlay$group == 'MEF2A_rm_plus'  & Tn5_unscaled_composites_overlay$x > 16 |
                                                             Tn5_unscaled_composites_overlay$group == 'MEF2A_rm_plus' & Tn5_unscaled_composites_overlay$x < -16),2])  

...
load('../data/Figure6_Tn5_unscaled_overlay.Rdata')
load('../data/Figure6_Tn5_RuleEnsemble_overlay.Rdata')
load('../data/Figure6_Tn5_seqOutBias_overlay.Rdata')
################################################################################
################################################################################
...
plot.composites(OLD_Tn5_RE_overlay, legend = FALSE, 
                pdf_name = 'Figure6B_seqOutBias_NNNCNN_Tn5_RE_overlay',
                ylabel = 'Cut Frequency',
                xlabel = 'Distance from Motif Center',
                motifline = FALSE, Motiflen = 0, figwidth = 12, figheight = 8, x_axis_range = -20:20)  


plot.composites(RE_Tn5_overlay, legend = FALSE, 
                pdf_name = 'Figure6B_Tn5_RE_overlay',
                ylabel = 'Cut Frequency',
                xlabel = 'Distance from Motif Center',
                motifline = FALSE, Motiflen = 0, figwidth = 12, figheight = 8, x_axis_range = -20:20)  
...
plot.composites(unscaled_Tn5_overlay, legend = FALSE, 
                pdf_name = 'Figure6B_unscaled_Tn5_overlay',
                ylabel = 'Cut Frequency',
                xlabel = 'Distance from Motif Center',
                motifline = FALSE, Motiflen = 0, figwidth = 12, figheight = 8, x_axis_range = -20:20)  

...
pdf(file = 'Figure6C_Redundant_Tn5_RE_variable_importances.pdf', width = 20, height = 18)
...
impbarplot +
  ...
  theme_classic() +
  theme(axis.title.x = element_text(size=88, colour = "black", face = 'bold'),
        axis.title.y = element_text(size=88, colour = "black", face = 'bold'),
